...
One entity, `Task` — a loop with a cadence, or a one-off with a due date. See
[docs/DATA_MODEL.md](docs/DATA_MODEL.md) for how cycles, prompts and chains work,
and what to touch when adding a field.
